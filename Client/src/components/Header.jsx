  ...
  return (
    <div className='flex flex-col justify-center items-center
     text-center my-20'>
        ...
        <h1 className='text-4xl mt-10 text-center'>Turn text to <span className='text-blue-600'>image</span>, in seconds.</h1>
        <p className='mt-5 text-center max-w-xl mx-auto'>
